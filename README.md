...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=20&pause=1000&color=1793D1&center=true&vCenter=true&width=500&lines=I+use+Arch+Linux+btw;Ethical+Hacker+in+training;Bug+Hunter;Fullstack+Security+Dev" alt="Typing SVG" />
</p>

---

### 🛡️ About Me
I am a highly motivated **Programmer** and **Cyber Security Enthusiast**. I live in the command line and believe in the philosophy of *Keep It Simple, Stupid* (KISS). Currently, I am refining my skills in penetration testing and secure software development while looking for professional opportunities to contribute and grow.

- 🖥️ **Daily Driver:** Arch Linux with a custom workflow.
- 🔐 **Core Interests:** Web Exploitation, Network Security, and Automation.
- ⚙️ **Workflow:** Neovim + Tmux + Zsh.
- 🔭 **Current Focus:** Building secure-by-design applications.
...
<p align="right"><i>Last updated: April 2024</i></p>
